...
module.exports = {
  async execute(client) {
    ...
    client.loadingEmbed = new EmbedBuilder().setAuthor({ name: "Loading.... Please Wait", iconURL: client.embed.loadingicon, url: "https://discord.gg/pXRT2FusPb" }).setColor(client.embed.stanbycolor)
